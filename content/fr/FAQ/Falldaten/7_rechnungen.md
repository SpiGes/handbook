...
{{<listItem>}}
Variable "zeitbezug": Avons-nous bien compris que pour chaque sortie (de l'année du relevé), les éléments de la facture doivent être fournis, sauf si le cas n'a pas encore été facturé à la date de remise des données ?
{{<collapsibleBlock groupId="rechnungen">}}
