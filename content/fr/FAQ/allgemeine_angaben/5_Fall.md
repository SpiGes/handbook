...
- Le premier cas doit être indiqué avec une décision de sortie "Transfert interne" (austrittsentscheid = 4), si la patient reste au sein du même hôpital.
- L'indication du séjour après la sortie (austritt_aufenthalt) sur le premier cas peut être décidée par l'établissement (éventuellement en discussion avec le canton).  
