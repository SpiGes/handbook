...
Cliquez sur "Démarrer", un message vert indique que la demande a bien été faite. Il faut toutefois attendre quelques secondes afin de voir la barre de progression. Cette dernière permet de visualiser l'état d'avancement de l'import jusqu'à son achèvement. Vous recevez un email quand les données ont été importées.  
